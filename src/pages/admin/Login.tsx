...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({ general: messages[code ?? ''] ?? 'Something went wrong. Please try again.' })
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#0a0f1e]">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-[-10%] right-[-5%] w-[400px] h-[400px] rounded-full bg-orange-500/15 blur-[100px] animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute top-[40%] right-[10%] w-[300px] h-[300px] rounded-full bg-yellow-400/10 blur-[80px] animate-pulse" style={{ animationDelay: '2s' }} />
        <div
...
/>
              ...
              <p className="mt-1 text-sm text-white/40 font-medium tracking-widest uppercase">Admin Portal</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5" noValidate>
              ...
              <div className="space-y-1">
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none">
                    <svg className={iconClass(!!errors.email)} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <div className="space-y-1">
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none">
                    <svg className={iconClass(!!errors.password)} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              >
                ...
                <span className="relative flex items-center justify-center gap-2 text-white">
                  {loading ? (
                    ...
                    <>
                      Sign In
                      <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform duration-150" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
